...
4. **Understand current state** — What notes exist? What's in inbox/? What does the graph look like?

**Orientation shortcuts:**
- The workspace tree (injected at session start or loaded manually) tells you what files exist
- Topic map descriptions tell you what topics contain without reading them
...
- Use ~60% for the actual work (reading sources, writing notes, finding connections)
